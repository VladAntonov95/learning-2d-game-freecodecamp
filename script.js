  ...
  class Game {
    ...
    render(context, deltaTime) {
      ...
      if (this.score >= this.winningScore) {
        ...
        let message1 = "Bullseye!!!";
        let message2 = "You bullied the bullies!";
        context.font = "130px Jaro";
        context.fillText(message1, this.width * 0.5, this.height * 0.5 - 30);
        context.font = "40px Jaro";
        context.fillText(message2, this.width * 0.5, this.height * 0.5 + 30);
        context.fillText(
          "Final score " + this.score + ". Press 'R' to bitt heads again!",
          this.width * 0.5,
          this.height * 0.5 + 80
        );
        context.restore();
      } else if (this.lostHatchlings >= 15) {
        this.gameOver = true;
        context.save();
        context.fillStyle = "rgba(0,0,0,0.5)";
        context.fillRect(0, 0, this.width, this.height);
    ...
    init() {
      ...
      let attempts = 0;
      while (
        this.obstacles.length < this.numbersOfObstacles &&
        attempts < 500
      ) {
